  ...
  return (
    <section className="flex overflow-hidden flex-col items-center px-20 pt-5 pb-40 w-full font-bold bg-slate-900 max-md:px-5 max-md:pb-24 max-md:max-w-full">
      <div className="flex flex-col items-center -mb-8 ml-3 max-w-full w-[1259px] max-md:mb-2.5">
        ...
        <p className="mt-16 text-xl leading-8 text-center text-slate-400 max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-wrap gap-2 mt-16 max-w-full text-base text-center text-white w-[525px] max-md:mt-10">
          <button className="grow shrink-0 px-3 pt-0.5 pb-6 bg-orange-400 rounded-xl basis-0 w-fit">
            <div className="flex gap-3 px-10 py-6 rounded-xl shadow-lg bg-white bg-opacity-0 max-md:px-5">
          ...
          <button className="flex flex-col justify-center self-start px-11 py-7 rounded-xl border border-solid border-orange-400 border-opacity-50 max-md:px-5">
            Our Methodology
          </button>
        </div>
      </div>
